...
export const aiLang: LangAtom = {
  "zh-Hans": {
    ...
    "quota_warning_3": "会员已于 {expiredStr} 到期\n<a href='{link}'>戳我立即续费🧋</a>",
  ...
  "zh-Hant": {
    ...
    "quota_warning_3": "會員已於 {expiredStr} 逾期\n<a href='{link}'>輕觸立即續費🧋</a>",
  ...
  "en": {
    ...
    "quota_warning_3": "Membership has expired on {expiredStr}.\n<a href='{link}'>Renew now 🧋</a>",
